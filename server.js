...
// Symboles testés dans l'ordre
const SYMBOLS = ['USOIL', 'WTI/USD', 'CL1!'];
...
async function getPrice() {
  for (const sym of SYMBOLS) {
    try {
      ...
      if (p > 10 && p < 500) return { price: p, symbol: sym };
    } catch(e) {
...
server.listen(PORT, () => console.log(`WTI Proxy v2 running on port ${PORT}`));
